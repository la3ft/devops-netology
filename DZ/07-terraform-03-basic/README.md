...
Список: 
```
root@vagrant:/home/vagrant/07-terraform-02-syntax/terraform# terraform workspace list
  default
* prod
  stage
 ```
...
Terraform will perform the following actions:
  ...
  + resource "yandex_compute_instance" "node01" {
      ...
      + network_interface {
          ...
          + subnet_id          = "e9b341e89ut85o3esusl"
        }
  ...
  # yandex_compute_instance.node02["prod"] will be created
  ...
  # yandex_compute_instance.node02["stage"] will be created
  + resource "yandex_compute_instance" "node02" {
      + allow_stopping_for_update = true
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
