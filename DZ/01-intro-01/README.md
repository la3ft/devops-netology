...
## Ответ:
1. Организовать работу команды по методологии agile: jira, gitlab, etc - проработать бизнес-процессы для всей команды: менеджер-аналитик-разработка-внедрение-тестирование-менеджер
1. Сделать непрерывный цикл разработки с помощью системы контроля версий (DevOps-инженер)
1. Создать юнит тестирование для готового кода
1. Создать автотестирование на конечных средах
1. Автоматизировать поставку новых версий с автотестированием (DevOps-инженер)
1. Настроить мониторинг ключевых параметров конечного продукта (DevOps-инженер)
1. Оформить доступное логирование (DevOps-инженер)
